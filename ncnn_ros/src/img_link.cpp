...
// 	Mat image_left = imread("/home/fuhua/desktop/img/gx_4625621.jpg.jpg");
// 	Mat image_right = imread("/home/fuhua/desktop/img/gx_5367238.jpg");
...
int main()
{
	Mat img1 = imread("/home/fuhua/desktop/img/gx_.jpg");//拼接图像1
	Mat img2 = imread("/home/fuhua/desktop/img/out.jpg");//拼接图象2

	const string filename = "/home/fuhua/desktop/img/out1.jpg";//结果路径
